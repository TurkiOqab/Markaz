...
// ---- Background composition (faithful to welcome-duty.html) ----
function Backdrop() {
  return (
    <>
      <div
      ...
      >
        ...
        >
          <defs>
            <linearGradient id="dutyScanLine" x1="0" y1="0" x2="1" y2="0">
            ...
            <linearGradient id="dutyScanLineSoft" x1="0" y1="0" x2="1" y2="0">
              <stop offset="0%" stopColor="#e8d9b8" stopOpacity="0" />
